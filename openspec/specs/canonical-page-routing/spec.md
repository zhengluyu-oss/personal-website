# canonical-page-routing Specification

## Purpose
Define the single canonical route for every public and administrator page while preserving metadata and backend API contracts.
