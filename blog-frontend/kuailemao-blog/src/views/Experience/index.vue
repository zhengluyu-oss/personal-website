...
@media(max-width:560px){.page{padding:6rem 1rem 4rem}.intro h1{font-size:clamp(2.8rem,14vw,4.2rem)}.row{min-height:0;padding:1.7rem 0}.row:hover{padding-left:.7rem;padding-right:.7rem}.row ul{font-size:.72rem}.closing{align-items:flex-start;flex-direction:column;gap:.8rem}}
