...
.featured-story__cover { position: relative; isolation: isolate; align-self: start; aspect-ratio: 16 / 10; min-width: 0; min-height: 0; overflow: hidden; background: var(--brand-canvas-soft); }
...
.story-cover__image { z-index: 1; object-fit: contain; object-position: center; }
...
.featured-story__content { display: flex; flex-direction: column; justify-content: center; min-width: 0; padding: clamp(1.5rem, 4vw, 3.25rem); }
